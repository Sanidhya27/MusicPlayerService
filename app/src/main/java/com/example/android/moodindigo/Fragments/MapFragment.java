...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //music float button
        final FloatingActionButton fab = (FloatingActionButton) mapView.findViewById(R.id.music_map_button);
...
//                    mediaPlayer.pause();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraPosition cameraPosition = new CameraPosition.Builder().target(new LatLng(19.131973, 72.914285)).zoom(17).tilt(80).build();
